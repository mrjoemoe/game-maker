...
Provides a headless, layered tile-board engine: configurable grid, tile types, face-up/face-down tile state, pieces, and deterministic game-state actions for prototyping.
