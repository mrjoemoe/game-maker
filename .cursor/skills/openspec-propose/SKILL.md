...
- When planning game-part work, inspect `npm run game -- catalog list|search` and record each affected part as reused, created, modified, pinned, migrated, deprecated, or variant-local
